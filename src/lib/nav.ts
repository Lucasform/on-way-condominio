...
export const NAV_COLOR: Record<string, string> = {
  ...
  '/solicitacoes': 'bg-gradient-to-br from-violet-500 to-violet-600',
  ...
  '/funcionalidades': 'bg-gradient-to-br from-violet-500 to-violet-600',
  '/assinaturas': 'bg-gradient-to-br from-emerald-500 to-teal-600',
  '/planos': 'bg-gradient-to-br from-emerald-500 to-emerald-600',
