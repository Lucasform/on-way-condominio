...
export default function TwoFactorPanel() {
  ...
  return (
    <div>
      ...
      {enrollment && (
        <div className="mt-4 p-5 border border-slate-700 rounded-md bg-slate-900/40 space-y-4">
          <div>
            ...
            <details className="mt-2 text-xs text-slate-500">
              ...
              <code className="mt-2 block bg-slate-800 px-3 py-2 rounded font-mono break-all text-xs">{enrollment.secret}</code>
            </details>
          </div>
          <div>
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              disabled={busy}
              className="px-4 py-2 rounded-md border border-slate-700 text-slate-200 text-sm font-medium hover:bg-slate-800"
            >
              Cancelar
            </button>
          </div>
