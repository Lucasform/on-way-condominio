  ...
  return (
    <AuthShell title="Política de Privacidade" subtitle="Versão 1.0 — em conformidade com a LGPD (Lei 13.709/2018)">
      <div className="prose prose-sm dark:prose-invert max-w-none text-slate-300 space-y-4">
        <section>
          <h3 className="font-semibold text-slate-100">1. Dados coletados</h3>
        ...
        <section>
          <h3 className="font-semibold text-slate-100">2. Finalidade</h3>
          <p>
        ...
        <section>
          <h3 className="font-semibold text-slate-100">3. Base legal</h3>
          <p>
        ...
        <section>
          <h3 className="font-semibold text-slate-100">4. Compartilhamento</h3>
          <p>
        ...
        <section>
          <h3 className="font-semibold text-slate-100">5. Direitos do titular</h3>
          <p>
        ...
        <section>
          <h3 className="font-semibold text-slate-100">6. Retenção</h3>
          <p>
        ...
        <section>
          <h3 className="font-semibold text-slate-100">7. Encarregado (DPO)</h3>
          <p>
            Contato para questões de privacidade: <a href="mailto:dpo@onwaytech.com.br" className="text-brand-400 hover:underline">dpo@onwaytech.com.br</a>.
          </p>
        </section>
      </div>
    </AuthShell>
