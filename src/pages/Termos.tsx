  ...
  return (
    <AuthShell title="Termos de Uso" subtitle="Versão 1.0 — vigente desde 26/05/2026">
      <div className="prose prose-sm dark:prose-invert max-w-none text-slate-700 dark:text-slate-300 space-y-4">
        <section>
          <h3 className="font-semibold text-slate-900 dark:text-slate-100">1. Objeto</h3>
          <p>
        ...
        <section>
          <h3 className="font-semibold text-slate-900 dark:text-slate-100">2. Uso da conta</h3>
          <p>
        ...
        <section>
          <h3 className="font-semibold text-slate-900 dark:text-slate-100">3. Conduta</h3>
          <p>
        ...
        <section>
          <h3 className="font-semibold text-slate-900 dark:text-slate-100">4. Encerramento</h3>
          <p>
        ...
        <section>
          <h3 className="font-semibold text-slate-900 dark:text-slate-100">5. Limitação de responsabilidade</h3>
          <p>
        ...
        <section>
          <h3 className="font-semibold text-slate-900 dark:text-slate-100">6. Foro</h3>
